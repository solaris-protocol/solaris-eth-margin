  ...
  return (
    <div>
      ...
      <div style={{ margin: 32 }}>
        ...
        {' '}
        are automatically injected into your frontend at
        <span
          className="highlight"
          style={{ marginLeft: 4, /* backgroundColor: "#f9f9f9", */ padding: 4, borderRadius: 4, fontWeight: "bolder" }}
        >
      ...
      <div style={{ marginTop: 32 }}>
        ...
        {' '}
        <b>{utils.formatEther(yourLocalBalance || 0)}</b>
      </div>
      ...
      <div style={{ margin: 8 }}>
        <div>
          <b>useTokenList()</b>
          {' '}
          can get you an array of tokens from
          {" "}
      ...
      <div style={{ marginTop: 32 }}>
        ...
        <span
          ...
          style={{ marginLeft: 4, /* backgroundColor: "#f9f9f9", */ padding: 4, borderRadius: 4, fontWeight: "bolder" }}
        >
          <Address address={address} minimized />
          {' '}
          {address}
        </span>
      </div>
